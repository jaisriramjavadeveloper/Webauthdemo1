...
public class AuthServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (path) {
            case "/login":
                request.getRequestDispatcher("/WEB-INF/auth/signin.jsp").forward(request, response);
                break;
            ...
            case "/forgotpassword":
                request.getRequestDispatcher("/WEB-INF/auth/forgot.jsp").forward(request, response);
                break;
